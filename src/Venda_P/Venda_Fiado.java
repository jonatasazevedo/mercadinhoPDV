...
public class Venda_Fiado extends javax.swing.JPanel {
    ...
    public Venda_Fiado() {
        Mecanismo.setJanelaselecionada(2);
    ...
    private void initComponents() {
        ...
        add(jLabel4);
        jLabel4.setBounds(480, 60, 60, 22);
        add(jTextField4);
        jTextField4.setBounds(540, 60, 200, 30);
        ...
        add(jLabel5);
        jLabel5.setBounds(170, 50, 160, 44);

        jLabel6.setFont(new java.awt.Font("Tahoma", 0, 36)); // NOI18N
        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel6.setText("Lista de compra");
        add(jLabel6);
        jLabel6.setBounds(880, 50, 320, 44);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(mp1.getRowCount()!=0){
            if(!jTextField4.getText().equals("")){
                ...
                JOptionPane.showMessageDialog(null,"Digite o nome do comprador fiado!!!");
                ac=false;
            }
        }
        if(ac){
